#!/usr/bin/env python
# -*- coding: utf-8 -*-
#Based on the work of Diego Bano - diego.bano@ug.uchile.cl
__author__ = 'Cristopher Gomez-Gallegos'
__email__  = 'cristopher.gomez@ug.uchile.cl'
...
class BaseSkill(object):
    ...
    def __init__(self):
        ...
        self.pose_pub = rospy.Publisher("/pepper_robot/cmd_vel", Twist, queue_size=1)
        self.pose_sub = rospy.Subscriber("/pepper_robot/odom", Odometry, self._update_pos)
    ...
    def move(self, distance=0.0, timeout=None, direction="forward"):
        """
                    ...
                    if distance != 0:
                        if abs(distance) - covered <= abs(distance) / 100.0:
                            ...
                            if direction == "right" or "left":
                                vel.linear.y = signo * self._get_linear_vel(abs(distance), covered)
    ...
    def move_forward(self, distance=0.0, timeout=None):
        ...
        return self.move(distance, timeout, "forward")
    ...
    def move_backwards(self, distance=0.0, timeout=None):
        ...
        return self.move(-distance, timeout, "backwards")
    ...
    def move_right(self, distance=0.0, timeout=None):
        ...
        return self.move(-distance, timeout, "right")
    ...
    def move_left(self, distance=0.0, timeout=None):
        ...
        rospy.loginfo("Starting movement.")
        self.move(distance=distance,timeout=timeout,direction="left")
